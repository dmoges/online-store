...
import static de.moges.onlineshop.domain.AssertUtils.bigDecimalCompareTo;
...
public class ProductAsserts {
    ...
    public static void assertProductUpdatableFieldsEquals(Product expected, Product actual) {
        assertThat(expected)
            ...
            .satisfies(e -> assertThat(e.getSizeType()).as("check sizeType").isEqualTo(actual.getSizeType()))
