...
describe('OrderItem Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 24589 };
      orderItem.product = product;

      const productCollection: IProduct[] = [{ id: 20345 }];
    ...
    it('Should call ProductOrder query and add missing value', () => {
      const orderItem: IOrderItem = { id: 456 };
      const order: IProductOrder = { id: 6699 };
      orderItem.order = order;

      const productOrderCollection: IProductOrder[] = [{ id: 25461 }];
    ...
    it('Should update editForm', () => {
      const orderItem: IOrderItem = { id: 456 };
      const product: IProduct = { id: 274 };
      orderItem.product = product;
      const order: IProductOrder = { id: 13394 };
      orderItem.order = order;
