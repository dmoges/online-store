package de.moges.onlineshop.config;
...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            createCache(cm, de.moges.onlineshop.repository.UserRepository.USERS_BY_LOGIN_CACHE);
            createCache(cm, de.moges.onlineshop.repository.UserRepository.USERS_BY_EMAIL_CACHE);
